...
pub(super) struct ToolCatalog {
    ...
    pub(super) memory_store: Option<Arc<dyn zbot_stores_traits::MemoryFactStore>>,
    pub(super) connector_provider: Option<Arc<dyn agent_primitives::ConnectorResourceProvider>>,
    pub(super) kg_store: Option<Arc<dyn knowledge_graph::kg_trait::KnowledgeGraphStore>>,
