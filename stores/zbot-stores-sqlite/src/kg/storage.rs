...
impl GraphStorage {
    ...
    /// `zbot-stores-sqlite` to drive impl-specific maintenance routines
    ...
    /// from a synchronous `spawn_blocking` closure in `zbot-stores-sqlite`.
...
impl GraphStorage {
    ...
    /// `KnowledgeGraphStore::mark_entity_archival` in zbot-stores for
